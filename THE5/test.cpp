...
//    test();
    ...
    partitions[6][5]= true;
    partitions[1][9]= true;
//    std::cout<< recursiveMethod(W, L, partitions, &numberOfCalls)<<std::endl;
//    std::cout<< numberOfCalls<<std::endl;
    std::cout<< bottomUpMethod(W, L, partitions, &numberOfCalls)<<std::endl;
    std::cout<< numberOfCalls<<std::endl;
